...
const TodoForm = () => {
    ...
    const onSubmit = async() => {
        if(todo?.hasOwnProperty("timestamp")) {
            ...
            const todoUpdated = {...todo, email:currentUser.email, timestamp: serverTimestamp()}
    ...
    return (
        <div ref={inputAreaRef}>
            ...
            <TextField fullWidth label="detail" multiline maxRows={4} value={todo.detail} onChange={(e) => setTodo({...todo, detail:e.target.value})} />
